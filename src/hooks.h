...
{
	static inline constexpr auto path = "Data/SKSE/INIs/";
	...
	static inline void ParseINIs()
	{
		...
		auto outputPath = path + std::string("SkyrimINIsOutput.txt");
		std::ofstream outputFile(outputPath);
		outputFile << "; Output autogenerated by Settings of Skyrim \n\n";
		outputFile << "; Skyrim INI settings \n";
		outputFile.close();
		strcpy_s(iniSettingsCollection->subKey, outputPath.c_str());
		iniSettingsCollection->OpenHandle(true);
		iniSettingsCollection->WriteAllSettings();
		iniSettingsCollection->CloseHandle();

		outputPath = path + std::string("SkyrimINIPreferencesOutput.txt");
		outputFile.open(outputPath, std::ios_base::app);
		outputFile << "; Output autogenerated by Settings of Skyrim \n\n";
		outputFile << "; Skyrim INI preference settings \n";
		outputFile.close();
			
		strcpy_s(iniPrefSettingsCollection->subKey, outputPath.c_str());
		iniPrefSettingsCollection->OpenHandle(true);
